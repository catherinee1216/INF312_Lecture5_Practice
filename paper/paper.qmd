...
We are interested in the height of Black Cheery Trees 

```{r}
#| label: fig-treeheight 
#| fig-cap: Balck CHerrt Tree Height 
#| echo: false 
...
ggplot(data = penguins,
  ...
  geom_point(aes(color = species,
             ...
             size = 15,
             alpha = 0.8) +
  scale_color_manual(values = c("orange", "darkorange", "darkorange1")) +
  labs(
    title = "Penguin size, Palmer Station LTER",
    subtitle = "Flipper length and body mass for Adelie, Chinstrap and Gentoo Penguins",
    x = "Flipper length (i think)",
    y = "Body mass (i think)",
...
datasets::morley |> 
  ...
  knitr::kable(
    col.names = c("Experiement Number", "Average Speed"), digits = 0
  )
